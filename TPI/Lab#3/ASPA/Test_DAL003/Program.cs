...
class Program
{
    private static void Main(string[] args)
    {
        ...
        using (IRepository repository = Repository.Create("Celebrities"))
        {
            ...
            {
                Console.WriteLine(
                    $"Id = {celebrity1.Id}, Firstname = {celebrity1.Firstname}, " +
            ...
            {
                Console.WriteLine(
                    $"Id = {celebrity3.Id}, Firstname = {celebrity3.Firstname}, " +
            ...
            {
                Console.WriteLine(
                    $"Id = {celebrity7.Id}, Firstname = {celebrity7.Firstname}, " +
            ...
            {
                Console.WriteLine(
                    $"Id = {celebrity222.Id}, Firstname = {celebrity222.Firstname}, " +
